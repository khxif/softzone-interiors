...
export default function AwardsSection() {
  ...
  return (
    <section
      className="award-bg relative flex h-screen w-full flex-col overflow-hidden
    items-center justify-start bg-opacity-65 md:py-8 md:flex-row md:justify-center"
    >
      <div className="w-full md:flex-1 md:pl-28 relative">
        <div
          className="transparent-bg flex h-full w-full flex-row items-center justify-center 
      ...
      <div
        className="overflow-y-scroll scrollbar-hide items-start
       relative z-10 bg-black/70 px-6 py-8 md:h-3/4 md:flex-1"
      >
        {year === "2024" && <Award2024 />}
        {year === "2023" && <Award2023 />}
      </div>
